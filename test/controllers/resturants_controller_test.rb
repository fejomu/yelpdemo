...
class ResturantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resturant" do
    assert_difference('Resturant.count') do
      post resturants_url, params: { resturant: { name: @resturant.name, phone: @resturant.phone, website: @resturant.website } }
    end
  ...
  test "should update resturant" do
    patch resturant_url(@resturant), params: { resturant: { name: @resturant.name, phone: @resturant.phone, website: @resturant.website } }
